  ...
  describe('criarPublica', () => {
    ...
    it('persists notaNPS, fotoFesta, permiteUsoFoto and comentario', async () => {
      ...
      await service.criarPublica('pedido-1', {
        ...
        fotoFesta: 'http://localhost/cdn/festa/abc.jpg',
        permiteUsoFoto: true,
      });
      ...
      expect(data.fotoFesta).toBe('http://localhost/cdn/festa/abc.jpg');
    ...
    it('rejeita 422 quando fotoFesta não é URL do CDN', async () => {
      ...
      await expect(
        service.criarPublica('pedido-1', {
          notaNPS: 9,
          comentario: 'amei',
          fotoFesta: 'https://evil.example/festa.jpg',
          permiteUsoFoto: true,
        } as any),
